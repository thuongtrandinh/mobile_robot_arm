...
namespace amr_nav2_mppi_controller
{

class MPPIController : public nav2_mppi_controller::MPPIController
{
};
...
PLUGINLIB_EXPORT_CLASS(amr_nav2_mppi_controller::MPPIController, nav2_core::Controller)
