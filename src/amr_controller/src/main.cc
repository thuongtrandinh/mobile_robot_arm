...
#include "amr_interfaces/msg/control_var.hpp"
#include "amr_interfaces/msg/joint_state.hpp"
#include "amr_interfaces/srv/ocp_local_plann.hpp"
#include "planner.h"
...
void PlannSrvCallback(
    const std::shared_ptr<amr_interfaces::srv::OcpLocalPlann::Request> req,
    std::shared_ptr<amr_interfaces::srv::OcpLocalPlann::Response> res) {
  ...
  amr_interfaces::msg::ControlVar cur_control_var{};
  res->success = false;
...
int main(int argc, char **argv) {
  ...
  auto plann_srv = robot_plann::_node->create_service<amr_interfaces::srv::OcpLocalPlann>(
