    ...
    rl_bridge_node = Node(
        ...
        parameters=[
            tuning_config,
            {
                ...
                "scan_obstacle_limit": 160,
                "scan_raytrace_shadow_enabled": True,
                "scan_raytrace_shadow_step": 0.30,
                "scan_raytrace_shadow_radius": 0.05,
                "scan_raytrace_shadow_max_range": 3.0,
                "use_map_static_obstacles": True,
                "map_static_sample_step_m": 0.20,
                "map_static_obstacle_limit": 80,
                "action_mask_use_local_costmap": False,
                "robot_radius": 0.25,
                "obstacle_radius": 0.05,
                "action_mask_clearance": 0.0,
                "human_safety_margin": 0.05,
        ...
        parameters=[
            {
                ...
                "local_costmap_max_cells": 800,
                "local_costmap_min_cost": 10,
                "astar_local_map_sample_step": 4,
                "astar_local_map_max_cells": 800,
