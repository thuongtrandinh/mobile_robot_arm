...
def launch_setup(context, *args, **kwargs):
    ...
    load_composable_node = LoadComposableNodes(
        ...
        composable_node_descriptions=[zed2_component]
    )
    ...
    return LaunchDescription(
        [
            ...
            DeclareLaunchArgument(
                ...
                description='The name of the zed2 node. All the topic will have the same prefix: `/<camera_name>/<node_name>/`. If a namespace is specified, the node name is replaced by the camera name.'),
            DeclareLaunchArgument(
