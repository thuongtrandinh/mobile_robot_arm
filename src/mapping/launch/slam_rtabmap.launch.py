...
def generate_launch_description():
    ...
    default_db_path = os.path.join(workspace_dir, "src", "mapping", "maps", "B3", "rtabmap_map.db")
    ...
    cfg_arg = DeclareLaunchArgument("cfg", default_value=os.path.join(mapping_dir, "config", "rtabmap_slam.yaml"))
    ...
    rtabmap_args_arg = DeclareLaunchArgument("rtabmap_args", default_value="")
    ...
    rtabmap_slam = IncludeLaunchDescription(
        ...
        launch_arguments={
            ...
            # XÓA HOÀN TOÀN IMU_TOPIC ĐỂ RTAB-MAP KHÔNG BỊ "NGÁO" TRỌNG LỰC
    ...
    return LaunchDescription([
        use_sim_time_arg, cfg_arg, database_path_arg, namespace_arg,
        rtabmap_args_arg, use_rviz_arg, rviz_config_arg,
        use_camera_arg, rgb_topic_arg, depth_topic_arg, camera_info_topic_arg,
